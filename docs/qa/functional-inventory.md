...
| DASH-001 | Dashboard | `/app/dashboard` | `DashboardPage` | Miembro profesional | Membresía activa | 5 enlaces | Nuevo evento; ver eventos; nuevo cliente | Resumir y abrir altas/listas | API de eventos/clientes | Sesión profesional | Estados loading, vacío y datos | 401, 403, red | Sí | E2E/manual real | Media | Estado vacío y datos reales revisados | — | Revisado real |
