...
builder.Services.AddScoped<RsvpSubmissionCoordinator>();
builder.Services.AddScoped<RsvpSensitiveDataService>();
builder.Services.AddScoped<RsvpProjectionReconciliationService>();
builder.Services.AddScoped<RsvpExportService>();
